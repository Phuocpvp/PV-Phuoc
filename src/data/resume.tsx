...
export const DATA = {
  ...
  summary:
    "Tôi là một chàng trai trẻ, với lòng nhiệt huyết với ngành công nghệ thông tin. ",
  avatarUrl: "/me.jpg",
  skills: [
    "Ăn",
    "Ngủ",
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Một blog cá nhân giới thiệu về Ngôn Ngữ Javascrip, giúp các bạn tìm hiểu và rõ hơn về ngôn ngữ này!",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
